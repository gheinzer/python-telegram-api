...
try:
    ...
    override_ok = 0
    try:
        os.chdir(pathforpackages + "py_telegrambot")
        os.chdir("C:/")
        print(
    ...
    if override_ok == 1:
        ...
        shutil.unpack_archive(old_path + "/module.tar",
                              extract_dir=pathforpackages + "py_telegrambot")
        progressbar.update(1)
        progressbar.close()
        print("Sucessfully Installed.\nYou can import the module with 'import py_telegrambot' now\nIf you need help, simply type 'python -m py_telegrambot --help' to the system shell.")
        time.sleep(5)
except:
